<?php
  /**
   * Fecha:  2020-01-29 - Update: 2020-02-10
   * 
   * @category   Components
   * @package    Moodle
...
if ($edit != '') {
    ...
    $editurl = new moodle_url('/mod/iteasyexam/delegations/addupddelegation.php', $param_edit);
    redirect($editurl);
}

if ($del != '') {
    iteasyexam_Delegations_delete($del);
}

$baseurl = new moodle_url('/mod/iteasyexam/delegations/index.php', null);
if ($contextid) {
...
$PAGE->set_url($CFG->wwwroot.'/mod/iteasyexam/delegations/index.php');
...
if (isloggedin() && $permissions ) {
    ...
    echo "<a href='./addupddelegation.php' class='btn btn-success'>&nbsp;&nbsp;".
    get_string(
        'add_delegation_form',
        'iteasyexam'
    )." &nbsp;</a><br>";
    ...
    $all_items = iteasyexam_Get_Total_delegations();
    $totalPag = ceil($all_items/$items_by_page_content);
    $baseurl = new moodle_url('/mod/iteasyexam/delegations/index.php', $params);
    ...
    echo "<tr>";
       ...
       $registered_data_delegations = iteasyexam_Delegations_content(
            $order,
            $dir,
            $page,
        ...
        $baseurlb = new moodle_url('/mod/iteasyexam/delegations/index.php', null);
        echo "<tbody>";
        foreach ($registered_data_delegations as $data) {
            echo "<tr>";
            echo "<td>";
            $id=$data->id;
            echo $data->id;
